...
lunch [<product>-<variant>]/[<product> <variant>]                       # Choose the device to target with the latest release.
lunch [<product>-<release>-<variant>]/[<product> <release> <variant>]   # Choose the device to target and a specific release.
